...
echo "<span class=td><img src=\"../dzimages/arrowpath.gif\" />&nbsp;Breaking News</a> <img src=\"../dzimages/arrowpath2.gif\" />&nbsp;Add</span><br><br>";
...
$sql=mysql_query("insert into breaking_news set  news_text='".$pname."', news_for = '". $newsFor."', date_added = '". date("Y-m-d")."'") or die (mysql_error());
