...
echo "<span class=td>&nbsp;<img src=\"../dzimages/arrowpath.gif\" />&nbsp;Breaking News <img src=\"../dzimages/arrowpath2.gif\" />&nbsp;View <img src=\"../dzimages/arrowpath2.gif\" />&nbsp;". $cat2Disp."</h2></div><br /><br></span>";
...
echo "<table width=\"100%\" align=\"right\"><tr bgcolor=\"#425d7b\" style='color:#fff' class=td><td align=left width=10%><font color=\"#ffffff\"><strong>Date</strong></font></td>
	    <td align=\"left\" halign=\"middle\" width=\"65%\"><font color=\"#ffffff\"><strong>Title</strong></font></td><td align=\"center\" halign=\"middle\" ><font color=\"#ffffff\" width=10%><strong>Edit</strong></font></td><td align=\"center\" halign=\"middle\" width=10% ><font color=\"#ffffff\"><strong>Delete</strong></font></td></tr>"; //<td align=\"left\" halign=\"middle\" width=\"35%\"><font color=\"#ffffff\"><strong>Sort Order</strong></font></td><td align=\"center\" halign=\"middle\" width=10% ><font color=\"#ffffff\"><strong>Extra Images</strong></font></td>
	...
	if($_GET["treatmentID"] == 0)
		 $query="select * from breaking_news where 1 order by date_added desc";
	else
...
//print_r($row);
	...
	echo "<tr bgcolor=\"$bg\" class=td><td>$edate</td>
			...
			echo "<td align=\"center\" halign=\"middle\"><a href=\"edit.php?id=$id\"><img src=\"../dzimages/edit.png\" alt=\"Edit\" border=\"0\" /></a></td><td align=\"center\" halign=\"middle\"><input type=checkbox name=t1[] value=$id></td></tr>";
} //<td halign=\"middle\">$sortOrder</td><td align=\"center\" halign=\"middle\"><a href=\"editimages.php?id=$id\" title='Edit Extra Images'><img src=\"../dzimages/edit.png\" alt=\"Edit\" border=\"0\" /></a></td>
