...
echo "<span class=td><img src=\"../dzimages/arrowpath.gif\" />&nbsp;Breaking News</a> <img src=\"../dzimages/arrowpath2.gif\" />&nbsp;Edit</span><br><br>";
...
$sql=mysql_query("update breaking_news set  news_text='".$pname."', news_for = '". $newsFor."' where id = ".$_POST["hID"]) or die (mysql_error());
...
{
$qryDNews = "Select * from breaking_news where id = ". $_GET["id"];
$rsDNews = mysql_query($qryDNews);
$rowDNews = mysql_fetch_assoc($rsDNews);
$arrNewsFor = explode("#",$rowDNews["news_for"]);
...
<table width="100%" border="0" align="left">
	<tr class="td">
	    ...
	    <td width="670"><textarea name="pname" class="required" id="pname" style="width:600px"><?php echo stripslashes($rowDNews["news_text"]); ?></textarea></td>
  	</tr>  	
	<tr class="td">
