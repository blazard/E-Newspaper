...
echo "<span class=td>&nbsp;<img src=\"../dzimages/arrowpath.gif\" />&nbsp;Inner Page(s) Banners <img src=\"../dzimages/arrowpath2.gif\" />&nbsp;View <img src=\"../dzimages/arrowpath2.gif\" />&nbsp;". $cat2Disp."</h2></div><br /><br></span>";
...
echo "<table width=\"100%\" align=\"right\"><tr bgcolor=\"#425d7b\" style='color:#fff' class=td><td align=left width=10%><font color=\"#ffffff\"><strong>Date</strong></font></td>
	    <td align=\"left\" halign=\"middle\" width=\"25%\"><font color=\"#ffffff\"><strong>URL</strong></font></td><td align=\"left\" halign=\"middle\" width=\"55%\"><font color=\"#ffffff\"><strong>Image</strong></font></td><td align=\"left\" halign=\"middle\" width=\"25%\"><font color=\"#ffffff\"><strong>Status</strong></font></td><td align=\"center\" halign=\"middle\" ><font color=\"#ffffff\" width=10%><strong>Location</strong></font></td><td align=\"center\" halign=\"middle\" ><font color=\"#ffffff\" width=10%><strong>Edit</strong></font></td><td align=\"center\" halign=\"middle\" width=10% ><font color=\"#ffffff\"><strong>Delete</strong></font></td></tr>"; //<td align=\"center\" halign=\"middle\" width=10% ><font color=\"#ffffff\"><strong>Extra Images</strong></font></td>
	...
	if($_GET["treatmentID"] == 0)
		 $query="select * from banners where banner_for != 'index' order by date_added desc";
	else
...
//print_r($row);
	...
	$image = "../../uploads/products/". $row["image_name"];
	
	$bg = ($bg=='#eeeeee' ? '#cccccc' : '#eeeeee');
	echo "<tr bgcolor=\"$bg\" class=td><td>$edate</td>
			<td halign=\"middle\"><a href=\"edit.php?id=$id\" title='Edit' style='text-decoration:none; color:#000000;'>$url</a></td>";
			
	echo "<td align=\"center\" halign=\"middle\">";
			...
			echo "</td><td align=\"center\" halign=\"middle\">". $row["banner_loc"]."</td><td align=\"center\" halign=\"middle\"><a href=\"edit.php?id=$id\"><img src=\"../dzimages/edit.png\" alt=\"Edit\" border=\"0\" /></a></td><td align=\"center\" halign=\"middle\"><input type=checkbox name=t1[] value=$id></td></tr>";
