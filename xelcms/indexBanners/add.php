...
echo "<span class=td><img src=\"../dzimages/arrowpath.gif\" />&nbsp;Index Page Banners</a> <img src=\"../dzimages/arrowpath2.gif\" />&nbsp;Add</span><br><br>";
...
$sql=mysql_query("insert into banners set  image_name ='".$i."', url = '".addslashes($_POST["url"])."',  banner_for = 'index', banner_loc = '". $_POST["displayLoc"]."', date_added = '". date("Y-m-d")."', banner_active = '".$_POST["bannerActive"]."'") or die (mysql_error());
...
-->	<tr class="td">
	...
	<tr class="td">
		...
		<!--	<input type="checkbox" name="newsFor[]" value="ev" />Eastern Voice
			...
			<input type="radio" name="displayLoc" id="displayLoc" value="bottom" />Bottom
