...
echo "<span class=td><img src=\"../dzimages/arrowpath.gif\" />&nbsp;Videos</a> <img src=\"../dzimages/arrowpath2.gif\" />&nbsp;Edit</span><br><br>";
...
$sql=mysql_query("update videos set video_title='".$pname."', video_desc = '". addslashes($_POST["long_desc"])."', video_code = '". addslashes($_POST["videoCode"])."', video_for = '". $newsFor."' where video_id = ".$_POST["hID"]) or die (mysql_error());
...
{
$qryDNews = "Select * from videos where video_id = ". $_GET["id"];
...
<input type="hidden" name="hID" value="<?php echo $rowDNews["video_id"];?>" />
<table width="100%" border="0" align="left">
	<tr class="td">
    	<td width="146">Heading/Title:</td>
	    <td width="670"><textarea name="pname" class="required" id="pname" style="width:600px"><?php echo stripslashes($rowDNews["video_title"]); ?></textarea></td>
  	</tr>  	
	<tr class="td">
    	<td width="146">Video code:</td>
	    <td width="670"><textarea name="videoCode" class="required" id="videoCode" style="width:600px"><?php echo stripslashes($rowDNews["video_code"]); ?></textarea></td>
  	</tr>  
	<tr class="td">
	    ...
	    <td width="670">
			...
			<input type="checkbox" name="newsFor[]" value="index" <?php if(in_array("index",$arrNewsFor)) echo 'checked="checked"'; ?> />Main Page
		</td>
  	</tr>
	<tr class="td">
...
$oFCKeditor->Value		= stripslashes($rowDNews["video_desc"]); //'<p>This is some <strong>sample text</strong>. You are using <a href="http://www.fckeditor.net/">FCKeditor</a>.</p>' ;
$oFCKeditor->Create() ;
?>	
	</td>
  </tr> 
