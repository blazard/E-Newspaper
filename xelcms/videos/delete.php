...
echo "<span class=td><img src=\"../dzimages/arrowpath.gif\" />&nbsp;<a href=\"view.php\" class=td\">Videos</a> <img src=\"../dzimages/arrowpath2.gif\" />&nbsp;Delete</span><br><br>";	
...
$delmaincat = @mysql_query("DELETE FROM videos WHERE video_id=".$sregion) or die(mysql_error());

}

if ($delmaincat) {
	echo "<tr><td class=td>Video(s) has been deleted. Please wait...</td></tr></table>";
	print '<meta http-equiv="refresh" content="2;URL=http:view.php">';
} else {
	echo "<tr><td class=td>Error deleting video(s). Please try again.</td></tr></table>";
