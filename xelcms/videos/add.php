...
echo "<span class=td><img src=\"../dzimages/arrowpath.gif\" />&nbsp;Videos</a> <img src=\"../dzimages/arrowpath2.gif\" />&nbsp;Add</span><br><br>";
...
$sql=mysql_query("insert into videos set  video_title='".$pname."', video_desc = '". addslashes($_POST["long_desc"])."', video_code = '". addslashes($_POST["videoCode"])."', video_for = '". $newsFor."', date_added = '". date("Y-m-d")."'") or die (mysql_error());
...
<table width="100%" border="0" align="left">
	...
	<tr class="td">
	    ...
	    <td width="670"><textarea name="videoCode" class="required" id="videoCode" style="width:600px"></textarea></td>
  	</tr>  	  
