...
echo "<span class=td><img src=\"../dzimages/arrowpath.gif\" />&nbsp;Articles</a> <img src=\"../dzimages/arrowpath2.gif\" />&nbsp;Edit</span><br><br>";
...
$sql=mysql_query("update articles set video_title='".$pname."', video_desc = '". addslashes($_POST["long_desc"])."', video_code = '". addslashes($_POST["videoCode"])."', video_for = '". $newsFor."' where video_id = ".$_POST["hID"]) or die (mysql_error());
...
{
$qryDNews = "Select * from articles where video_id = ". $_GET["id"];
...
<table width="100%" border="0" align="left">
	...
	<tr class="td">
	    ...
	    <td width="670"><input name="videoCode" type="text" class="required" id="videoCode" style="width:600px" value="<?php echo stripslashes($rowDNews["video_code"]); ?>" /></td>
  	</tr>  
	<tr class="td">
